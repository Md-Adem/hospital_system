                    ...
                    <div class="card custom-card">
                        <div class="card-header  border-bottom-0 pb-0">
                            <div>
                                ...
                                <span class="d-block tx-12 mt-2 mb-0 text-muted"> project work involves a group of students
                                    investigating . </span>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="card-header border-bottom-0 pt-0 pl-0 pr-0 d-flex">
                                <div>
                                    <label class="main-content-label mb-2">Tasks</label> <span
                                        class="d-block tx-12 mb-3 text-muted">A task is accomplished by a set deadline, and
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                <div class="demo-avatar-group my-auto float-right">
                                                    ...
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/2.jpg') }}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/3.jpg') }}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/4.jpg') }}">
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                <div class="demo-avatar-group my-auto float-right">
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/5.jpg') }}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/6.jpg') }}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/7.jpg') }}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/8.jpg') }}">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">37<i class=""></i></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                <div class="demo-avatar-group my-auto float-right">
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/11.jpg') }}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/12.jpg') }}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/9.jpg') }}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{ URL::asset('assets/img/users/10.jpg') }}">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">37<i class=""></i></td>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-auto">
                            <div class="mt-3">
                                <div class="">
                                    <img alt="" class="ht-50"
                                        src="{{ URL::asset('assets/img/media/project-logo.png') }}">
                                </div>
                            </div>
                        </div>
                    </div>
